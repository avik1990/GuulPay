...
class QuicksandLightTextview : AppCompatTextView {
    ...
    fun setCustomFont(context: Context?, customFont: String?, isBold: Boolean) {
        try {
            ...
            Log.e("QuicksandLightTextview", exception.toString())
        }
    }

    constructor(context: Context) : super(context) {
        setCustomFont(context, context.getString(R.string.quicksandLight), false)
    }
