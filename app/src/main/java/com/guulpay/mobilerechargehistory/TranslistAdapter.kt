...
class TranslistAdapter(private val context: Context, private val countryList: ArrayList<OperatorModel.Operatorlist>, private val countryCodesItemSelect: OnCountryCodesItemSelect) : BaseAdapter() {
